% Transmissão digital utilizando modulação BPSK num canal com ruído AWGN e
% desvanecimento, devido a propagação de multiplo percurso, modelada por
% uma distribuição de Rayleigh. 
% Equalização é realizada na saída do canal para que a detecção dos
% símbolos seja coerente.
